...
ssh -Tq $i <<EOF
		...
		iptables -A mysqldb -p tcp --dport 4567 -j ACCEPT
		iptables -A mysqldb -p tcp --dport 4444 -j ACCEPT
		iptables -A mysqldb -p udp --dport 3306 -j ACCEPT
		iptables -A mysqldb -p udp --dport 4567 -j ACCEPT
		iptables -A mysqldb -p udp --dport 4444 -j ACCEPT
